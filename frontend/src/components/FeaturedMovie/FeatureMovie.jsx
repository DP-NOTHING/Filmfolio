            ...
            <div className="featured--vertical">
                <div className="featured--horizontal">
                    ...
                    <div className="featured--info">
                        <div className="featured--points">{item.vote_average} Rated</div>
                    ...
                    <div className="featured--buttons">
                        <a className="featured--watchbutton" href={"/player"}>▶ play</a>
                        <a className="featured--mylistbutton" href={`/list/add/${item.id}`}>+Add</a>
                    </div>
